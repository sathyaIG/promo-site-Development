...
@section('pageurl', admin_url('UserEdit'))
<style type="text/css">
    .error {
        color: red;
        margin: 10px;
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <hr>
                                <form id="UserEdit" autocomplete="off" class="forms-sample" method="post" action="{{ admin_url('user_management/edit/' . encryptId($user_details['id'])) }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3 form-group">
                                            ...
                                            <input type="text" class="form-control" id="user_name" name="user_name" value="{{ $user_details['name'] }}" placeholder="User Name">
                                            @error('user_name')
                                        ...
                                        <div class="col-md-6 mb-3 form-group">
                                            ...
                                            <input type="text" class="form-control " name="mobile" id="mobile" value="{{ $user_details['mobile'] }}" placeholder="Contact Number">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3 form-group">
                                            ...
                                            <input type="text" class="form-control" id="email" name="email" value="{{ $user_details['email'] }}" placeholder="Email">                                            
                                         ...
                                         <div class="col-md-6 mb-3 form-group hideforothers" style="display: none;">
                                            ...
                                            <input type="text" class="form-control" id="email1" name="email1" value="{{ $user_details['email_1'] }}" placeholder="Email">
                                         ...
                                         <div class="col-md-6 mb-3 form-group hideforothers" style="display: none;">
                                            ...
                                            <input type="text" class="form-control" id="email2" name="email2" value="{{ $user_details['email_2'] }}" placeholder="Email">
                                        ...
                                        <div class="col-md-6 mb-3 form-group">
                                            ...
                                            <select class="form-select " name="user_role" disabled id="user_role" aria-label="Default select example">
                                                <option value=''>Select User Role</option>
                                                @foreach ($userrole_details as $userrole)
                                                <option @if ($user_details['role']==$userrole['id'])  selected @endif value="{{ $userrole->id }}">
                                                    {{ $userrole->user_role }}
                                                </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3 form-group">
                                            ...
                                            <select class="form-select multiple-select" name="department[]" multiple aria-label="Default select example">
                                                @foreach ($department_details as $department)
                                                <option @if (in_array($department['id'], $selected_department)) selected @endif value="{{ encryptId($department->id) }}">
                                        ...
                                        <div class="col-md-6 mb-3 form-group">
                                            ...
                                            <select class="form-select multiple-select" name="business_type[]" multiple="multiple" id="business_type" aria-label="Default select example">
                                                @foreach ($business_type_details as $business_type)

                                                <option @if (in_array($business_type['id'], $selected_business)) selected @endif value="{{ encryptId($business_type->id) }}">
                                    ...
                                    @if($user_details['role'] != 1)
                                        <div class="col-md-6 mb-3 form-group hideformanufacturer" style="display: none;">
                                            ...
                                            <select class="form-select multiple-select" name="manufacturer[]" id="manufacturer" style="width: 100%;" multiple="multiple">
                                                ...
                                                <option @if (in_array($manufacturerlist['id'], $selected_manufacturer)) selected @endif value="{{ encryptId($manufacturerlist->id) }}">
                                    ...
                                    @endif
                                        {{-- <div class="col-md-6 mb-3 form-group hideforothers" style="display: none;">
                                            ...
                                            <input type="number" min="0" class="form-control" value="{{ $user_details['categories']}}" placeholder="Funding Category" name="category">
                                        </div>


                                        <div class="col-md-6 mb-3 form-group hideforothers" style="display: none;">
                                            <label class="form-label required">Redemption Limit - Qty Per Member <span style="color: red">*</span></label>
                                            <input type="text" class="form-control" value="{{ $user_details['redemptionPerMember']}}" placeholder="Redemption Limit - Qty Per Member" name="member" id="member">
                                        </div>
                                        <div class="col-md-6 mb-3 form-group hideforothers" style="display: none;">
                                            <label class="form-label required">Redemption Limit - Qty Per Order <span style="color: red">*</span></label>
                                            <input type="text" class="form-control" value="{{ $user_details['redemptionPerOrder']}}" placeholder="Redemption Limit - Qty Per Order" name="order" id="order">
                                        </div>


                                        <div class="col-md-6 mb-3 form-group hideforothers" style="display: none;">
                                            <label class="form-label required">Invoice <span style="color: red">*</span></label></br>
                                            <input type="radio" name="invoice" id="invoice_true" value="1" {{ $user_details['invoice'] ? 'checked' : '' }} /> True
                                            <input type="radio" name="invoice" id="invoice_false" value="0" {{ !$user_details['invoice'] ? 'checked' : '' }} /> False
                                        </div> --}}
                                        <div class="col-md-6 mb-3 form-group">
                                            <label class="form-label">Profile Image </label>
                                            <input class="form-control" type="file" name="profile_image" id="profile_image" accept=".png, .jpg, .jpeg" value="{{ getProfileImage($user_details['profile_image']) }}" style="border-radius: 1.25rem;" onchange="return fileValidation()">
                                            <span id="profile_image_error" class="error"></span>
                                        </div>
                                    </div>

                                    <div class="text-end mt-3">
                                        <button type="submit" id="user_add" class="px-4 btn btn-primary btn-skew"><span class="fs-7">Update</span></button>
...
<script type="text/javascript">
    ...
    $(function() {
        let currentUserValue = $('#user_role').val();
        if (currentUserValue == 5) {
            $('.hideforothers').css('display', 'block');
            $('.hideformanufacturer').css('display', 'none');
        } else {
