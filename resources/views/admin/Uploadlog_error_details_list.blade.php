                    ...
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="col" style="text-align: end;">
                                    <a class="btn btn-outline-success" href="{{ admin_url('UploadFileDownload/'.encryptId($upload_id)) }}"> Download</a>
                                    <a class="btn btn-outline-primary" href="{{ admin_url('upload_logs') }}"> Back</a>
                                </div>
                            <hr>
...
<script type="text/javascript">
    $(function() {
        ...
        var table = $('#upload_list_table').DataTable({
            ...
            ajax: {
                url: "{{ admin_url('Upload_view/' . encryptId($upload_id)) }}",
                type: 'GET',
                data: function(d) {
