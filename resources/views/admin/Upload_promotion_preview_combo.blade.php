                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body" style="position: relative;">
                                ...
                                <!-- <form class="float-right" action="{{ admin_url('Download_dispatch_combo/' . encryptId($promotion->id)) }}" id="download_certificate" method="post" style="margin-left: 850px;margin-top: 39px;">
                                    @csrf
    ...
    <div id="Upload_promotion_modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="Upload_promotion_modalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="UploadPromotypes" class="forms-sample" method="post" action="{{ admin_url('PromotypeFileEditCombo/' . encryptId($promotion->id)) }}" enctype="multipart/form-data">
                    @csrf
