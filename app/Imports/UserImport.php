    ...
    public function collection(Collection $rows)
    {
        ...
        foreach ($rows as $row) {
            ...
            if ($row['5'] != '') {
                ...
                $campaign_details = CampaignType::whereIn('campaign_type', $campaign_array)->pluck('id');
                ...
                $cond_error_data = array(
                    'log_id' => $this->log_id,
                    'file_name' => "Error in the Line Number " . $i,
                    'error' => 'Campaign Booking Type is missing',
                );
                $insert_id = DB::table('admin_upload_error_log')->insert($cond_error_data);
                $i++;
                continue;
            ...
            if ($user_details != null) {
                ...
                User::where('id', $user_details->id)->update($update_data);
            } else {
